...
import styles from "./ShopAnimation.module.scss";
...
export default function ShopAnimation({ categorySlugs }) {
      ...
      <div className="_container">
        <div className={styles.shopContainer}>
          <div className={styles.shopTop}>
            <h2>Instant Solutions for Personal Expression</h2>
